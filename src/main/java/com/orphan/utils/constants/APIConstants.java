package com.orphan.utils.constants;
...
public class APIConstants {
    ...
    public static final String REPLACE_INT = "%c";
    ...
    public static final String FUND = "Fund in/out";
    ...
    public static final String MAIl_NOTIFICATION = "Mail notification";
