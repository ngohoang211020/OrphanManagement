...
import com.orphan.utils.file.FileUploadUtil;
...
public class AdminController {
    ...
    @PostMapping()
    public ResponseEntity<?> createUser(@RequestBody RegisterRequestDto newUserRegisterInfo
    ...
    public ResponseEntity<?> updateUserDetail(@PathVariable("userId") Integer userId, @RequestBody RegisterRequestDto registerRequestDto) throws BadRequestException, NotFoundException {
